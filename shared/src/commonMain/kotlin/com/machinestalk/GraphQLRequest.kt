 ...
 */
@Serializable
class GraphQLRequest(val query: String?,val operationName: String?,
     ...
     */
    data class Builder(
        var query: String?=null,var operationName: String?=null,var variables: HashMap<String,String>?=null) {
